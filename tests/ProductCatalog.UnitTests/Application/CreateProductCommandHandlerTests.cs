...
public class CreateProductCommandHandlerTests
{
    ...
    {
        _handler = new CreateProductCommandHandler(_productsRepo.Object, _idGenerator.Object, _unitOfWork.Object, Mock.Of<ILogger<CreateProductCommandHandler>>());
    }
    ...
    public async Task Handle_SaveThrowsUniqueConstraintViolationOnce_RetriesAndSucceeds()
    {
        ...
        _productsRepo.Verify(r => r.AddAsync(It.IsAny<Product>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
    }
